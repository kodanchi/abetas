...
<%
    ...
    ArrayList<String> uniData = dbs.selectUniversityData();
                            ...
                            <tbody>
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            out.print("<input type=\"hidden\" id=\"stdntNmbr\" name=\"studentsNumber\" value=\""+rs.size()+"\">");
...
--%>
                        ...
                        <button id="confirm" class="btn btn-primary pull-right" formaction="/SubmitSummative" type="button" >Submit</button>
                            ...
                            $(function () {
                                ...
                                function Validate(groupname) {
                                    ...
                                    for (var i = 0; i < radios.length; i++) {
                                        if (radios[i].checked) {
                                            ...
                                            var tr =radios[0].parentNode.parentNode.parentNode.parentNode;
                                    ...
                                    tr.focus();
                                    document.getElementById('radioErr').innerHTML = 'All students must be marked!!!';
                                    return false;
                                }
                                ...
                                $("button#confirm").click(function(e) {
                                    ...
                                    bootbox.confirm("when submitting this form you cannot access it again to edit the entered " +
                                        ...
                                        studentsNum = document.getElementById("stdntNmbr").value;
