    ...
    <span class="input-group-btn">
                    <span class="btn btn-fill btn-primary btn-file">
                        Browse&hellip; <input type="file">
                                            ...
                                            <input id="ulogo" type="text" class="form-control" readonly>
                                        </div>
                                ...
                                <div class="tab-pane" id="tab4">
                                    <div class="jumbotron">
                                        <h4>Enter Administrator's details:</h4>
                                ...
                                <div class="tab-pane" id="tab6">
                                    <div class="jumbotron">
                                        <p>
                                            Please confirm all the previous data you entered, then click finish to begin setting up the database.
                                        </p>
                                    </div>
                                </div>

                                <ul class="pager wizard">
                                    <li class="previous"><a class="btn btn-info btn-fill btn-lg" href="#">Previous</a></li>
                                    <li class="next last" style="display:none;"><a class="btn btn-primary btn-fill" href="#">Last</a></li>
                                    <li class="next"><a class="btn btn-info btn-fill btn-lg" href="#">Next</a></li>
                                    <li class="finish"><a class="btn btn-success btn-fill btn-lg" href="javascript:;">Finish</a></li>
                                </ul>
                            </div>
                        </div>
