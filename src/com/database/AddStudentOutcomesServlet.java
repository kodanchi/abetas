 ...
 */
@WebServlet(name = "AddStudentOutcomesServlet",
        urlPatterns = {"/37"})
public class AddStudentOutcomesServlet extends HttpServlet {
    ASDB dba;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<!DOCTYPE html>\n" +
                ...
                "<div class=\"container\">\n" +
                "    <div>\n" +
                "        <p>Program >> Objectives >>outcomes>></p>\n" +
                "        <h1>Add Student Outcome</h1>\n" +
                "        <p>You need to add student outcomes or upload excel file.</p>\n" +
        ...
        dba=new ASDB();
        try {
            ArrayList<ArrayList<String>> rs = dba.selectStudentOutcomes();
        ...
        out.print( "</tr>\n" +
                ...
                "        <a class=\"btn btn-lg btn-success\" href=\"#\" role=\"button\">Previous</a></p>\n" +
